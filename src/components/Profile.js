    ...
    return (
        <div className="profile-fact">
            ...
            <div className="profile-social">
                <a href = "mailto: sanjeeb4223@gmail.com" className="underline"><button className="email"><i className="fa-solid fa-envelope"></i>Email</button></a>
                <a href="https://www.linkedin.com/in/sanjeebdev/" target="_blank" className="underline"><button className="linkedin"><i className="fa-brands fa-linkedin"></i>LinkedIn</button></a>
            </div>
